...
internal static class PluginRuntimeDependencyManager
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            ConsoleOutput.Info($"正在下载插件 native 依赖: {package.Id} {package.Version} ({runtimeIdentifier})");
            ...
            ConsoleOutput.Success($"插件 native 依赖已准备: {package.Id} {package.Version} ({runtimeIdentifier})");
